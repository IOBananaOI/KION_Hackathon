...
#         return vid2url
    ...
    def getDataloader(self,train_dset,val_dset,test_dset):
        ...
        train_loader=DataLoader(train_dset,batch_size = self.cfg.batch_size, num_workers = 0,shuffle = True,
                        collate_fn = collate_fn, drop_last=True)

        val_loader = DataLoader(val_dset,batch_size = 10, num_workers = 0,shuffle = False,collate_fn = collate_fn,
                         drop_last=False)
        test_loader = DataLoader(test_dset,batch_size = 10, num_workers = 0,shuffle = False,collate_fn = collate_fn,
                         drop_last=False)
